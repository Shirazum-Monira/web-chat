...
<html>  
  ...
  <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
    ...
    <body style="background-image: url(indexpic.jpg); background-repeat:no-repeat;background-attachment: fixed;background-position: center;background-size: cover;">
    <body style="background-color: white);">
    <header>
    <div class="nav">
      <ul>
        <li class="home"><a class="active" href="index.php">Home</a></li>
        <li class="tutorials"><a href="changeInfo.php">Settings</a></li>
   ...
   <h2 align="center" style="font-family: Algerian">WEB CHAT APPLICATION</a></h2><br />
   <br />
   
   <div class="table-responsive">
    <h4 align="center"><u>Online User</u></h4>
    <h4 align="right">Hi - <?php echo $_SESSION['username'];  ?></h4>
